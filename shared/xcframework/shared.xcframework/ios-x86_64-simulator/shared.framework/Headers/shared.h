...
@interface SharedActions : SharedBase
- (instancetype)initWithActions:(NSArray<SharedAddTagAction *> *)actions __attribute__((swift_name("init(actions:)"))) __attribute__((objc_designated_initializer));
- (NSArray<SharedAddTagAction *> *)component1 __attribute__((swift_name("component1()")));
- (SharedActions *)doCopyActions:(NSArray<SharedAddTagAction *> *)actions __attribute__((swift_name("doCopy(actions:)")));
- (BOOL)isEqual:(id _Nullable)other __attribute__((swift_name("isEqual(_:)")));
- (NSUInteger)hash __attribute__((swift_name("hash()")));
- (NSString *)description __attribute__((swift_name("description()")));
@property (readonly) NSArray<SharedAddTagAction *> *actions __attribute__((swift_name("actions")));
@end;

__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("Actions.Companion")))
@interface SharedActionsCompanion : SharedBase
...
__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("ActionsResponse")))
@interface SharedActionsResponse : SharedBase
- (instancetype)initWithAction_results:(NSArray<SharedBoolean *> *)action_results __attribute__((swift_name("init(action_results:)"))) __attribute__((objc_designated_initializer));
- (NSArray<SharedBoolean *> *)component1 __attribute__((swift_name("component1()")));
- (SharedActionsResponse *)doCopyAction_results:(NSArray<SharedBoolean *> *)action_results __attribute__((swift_name("doCopy(action_results:)")));
- (BOOL)isEqual:(id _Nullable)other __attribute__((swift_name("isEqual(_:)")));
- (NSUInteger)hash __attribute__((swift_name("hash()")));
- (NSString *)description __attribute__((swift_name("description()")));
@property (readonly) NSArray<SharedBoolean *> *action_results __attribute__((swift_name("action_results")));
@end;

__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("ActionsResponse.Companion")))
@interface SharedActionsResponseCompanion : SharedBase
+ (instancetype)alloc __attribute__((unavailable));
+ (instancetype)allocWithZone:(struct _NSZone *)zone __attribute__((unavailable));
+ (instancetype)companion __attribute__((swift_name("init()")));
- (id<SharedKotlinx_serialization_coreKSerializer>)serializer __attribute__((swift_name("serializer()")));
...
__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("AddTagAction")))
@interface SharedAddTagAction : SharedBase
- (instancetype)initWithItem_id:(NSString *)item_id tags:(NSString *)tags action:(NSString *)action __attribute__((swift_name("init(item_id:tags:action:)"))) __attribute__((objc_designated_initializer));
- (NSString *)component1 __attribute__((swift_name("component1()")));
- (NSString *)component2 __attribute__((swift_name("component2()")));
- (NSString *)component3 __attribute__((swift_name("component3()")));
- (SharedAddTagAction *)doCopyItem_id:(NSString *)item_id tags:(NSString *)tags action:(NSString *)action __attribute__((swift_name("doCopy(item_id:tags:action:)")));
- (BOOL)isEqual:(id _Nullable)other __attribute__((swift_name("isEqual(_:)")));
- (NSUInteger)hash __attribute__((swift_name("hash()")));
- (NSString *)description __attribute__((swift_name("description()")));
...
@property (readonly) NSString *tags __attribute__((swift_name("tags")));
@end;

__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("AddTagAction.Companion")))
@interface SharedAddTagActionCompanion : SharedBase
+ (instancetype)alloc __attribute__((unavailable));
+ (instancetype)allocWithZone:(struct _NSZone *)zone __attribute__((unavailable));
+ (instancetype)companion __attribute__((swift_name("init()")));
- (id<SharedKotlinx_serialization_coreKSerializer>)serializer __attribute__((swift_name("serializer()")));
...
- (instancetype)initWithId:(NSString *)id title:(NSString *)title tags:(NSDictionary<NSString *, SharedTagResponse *> * _Nullable)tags url:(NSString *)url excerpt:(NSString *)excerpt images:(NSDictionary<NSString *, SharedArticleImage *> *)images __attribute__((swift_name("init(id:title:tags:url:excerpt:images:)"))) __attribute__((objc_designated_initializer));
- (NSString *)component1 __attribute__((swift_name("component1()")));
- (NSString *)component2 __attribute__((swift_name("component2()")));
- (NSDictionary<NSString *, SharedTagResponse *> * _Nullable)component3 __attribute__((swift_name("component3()")));
- (NSString *)component4 __attribute__((swift_name("component4()")));
- (NSString *)component5 __attribute__((swift_name("component5()")));
- (NSDictionary<NSString *, SharedArticleImage *> *)component6 __attribute__((swift_name("component6()")));
- (SharedArticle *)doCopyId:(NSString *)id title:(NSString *)title tags:(NSDictionary<NSString *, SharedTagResponse *> * _Nullable)tags url:(NSString *)url excerpt:(NSString *)excerpt images:(NSDictionary<NSString *, SharedArticleImage *> *)images __attribute__((swift_name("doCopy(id:title:tags:url:excerpt:images:)")));
- (BOOL)isEqual:(id _Nullable)other __attribute__((swift_name("isEqual(_:)")));
- (NSUInteger)hash __attribute__((swift_name("hash()")));
- (SharedArticleImage * _Nullable)mainImage __attribute__((swift_name("mainImage()")));
- (NSString *)description __attribute__((swift_name("description()")));
@property (readonly) NSString *excerpt __attribute__((swift_name("excerpt")));
@property (readonly) NSString *id __attribute__((swift_name("id")));
@property (readonly) NSDictionary<NSString *, SharedArticleImage *> *images __attribute__((swift_name("images")));
@property (readonly) NSDictionary<NSString *, SharedTagResponse *> * _Nullable tags __attribute__((swift_name("tags")));
...
__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("Article.Image")))
@interface SharedArticleImage : SharedBase
- (instancetype)initWithSrc:(NSString *)src __attribute__((swift_name("init(src:)"))) __attribute__((objc_designated_initializer));
- (NSString *)component1 __attribute__((swift_name("component1()")));
- (SharedArticleImage *)doCopySrc:(NSString *)src __attribute__((swift_name("doCopy(src:)")));
- (BOOL)isEqual:(id _Nullable)other __attribute__((swift_name("isEqual(_:)")));
- (NSUInteger)hash __attribute__((swift_name("hash()")));
- (NSString *)description __attribute__((swift_name("description()")));
...
__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("Article.ImageCompanion")))
@interface SharedArticleImageCompanion : SharedBase
+ (instancetype)alloc __attribute__((unavailable));
+ (instancetype)allocWithZone:(struct _NSZone *)zone __attribute__((unavailable));
+ (instancetype)companion __attribute__((swift_name("init()")));
- (id<SharedKotlinx_serialization_coreKSerializer>)serializer __attribute__((swift_name("serializer()")));
...
__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("ArticleListResponse")))
@interface SharedArticleListResponse : SharedBase
- (instancetype)initWithList:(NSDictionary<NSString *, SharedArticle *> *)list __attribute__((swift_name("init(list:)"))) __attribute__((objc_designated_initializer));
- (NSDictionary<NSString *, SharedArticle *> *)component1 __attribute__((swift_name("component1()")));
- (SharedArticleListResponse *)doCopyList:(NSDictionary<NSString *, SharedArticle *> *)list __attribute__((swift_name("doCopy(list:)")));
- (BOOL)isEqual:(id _Nullable)other __attribute__((swift_name("isEqual(_:)")));
- (NSUInteger)hash __attribute__((swift_name("hash()")));
- (NSString *)description __attribute__((swift_name("description()")));
@property (readonly) NSDictionary<NSString *, SharedArticle *> *list __attribute__((swift_name("list")));
@end;

__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("ArticleListResponse.Companion")))
@interface SharedArticleListResponseCompanion : SharedBase
+ (instancetype)alloc __attribute__((unavailable));
+ (instancetype)allocWithZone:(struct _NSZone *)zone __attribute__((unavailable));
+ (instancetype)companion __attribute__((swift_name("init()")));
- (id<SharedKotlinx_serialization_coreKSerializer>)serializer __attribute__((swift_name("serializer()")));
...
@interface SharedLoginViewModel : SharedBase
- (instancetype)initWithPocketApi:(SharedPocketApi *)pocketApi urlLauncher:(id<SharedURLLauncher>)urlLauncher userStore:(id<SharedUserStore>)userStore __attribute__((swift_name("init(pocketApi:urlLauncher:userStore:)"))) __attribute__((objc_designated_initializer));

/**
 @note This method converts instances of CancellationException to errors.
 Other uncaught Kotlin exceptions are fatal.
*/
- (void)continueLoginWithCompletionHandler:(void (^)(SharedKotlinUnit * _Nullable, NSError * _Nullable))completionHandler __attribute__((swift_name("continueLogin(completionHandler:)")));

/**
 @note This method converts instances of CancellationException to errors.
 Other uncaught Kotlin exceptions are fatal.
*/
- (void)loginRedirectUrl:(NSString *)redirectUrl completionHandler:(void (^)(SharedKotlinUnit * _Nullable, NSError * _Nullable))completionHandler __attribute__((swift_name("login(redirectUrl:completionHandler:)")));
- (BOOL)needsLogin __attribute__((swift_name("needsLogin()")));

/**
 @note This method converts instances of CancellationException to errors.
 Other uncaught Kotlin exceptions are fatal.
*/
- (void)startLaunchingFresh:(BOOL)launchingFresh continuing:(id<SharedKotlinSuspendFunction0>)continuing completionHandler:(void (^)(SharedKotlinUnit * _Nullable, NSError * _Nullable))completionHandler __attribute__((swift_name("start(launchingFresh:continuing:completionHandler:)")));
@end;

__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("MainRouter")))
@interface SharedMainRouter : SharedBase
- (instancetype)init __attribute__((swift_name("init()"))) __attribute__((objc_designated_initializer));
+ (instancetype)new __attribute__((availability(swift, unavailable, message="use object initializers instead")));
...
__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("MainScreenViewModel")))
@interface SharedMainScreenViewModel : SharedBase
- (instancetype)initWithPocketApi:(SharedPocketApi *)pocketApi tagsRepository:(id<SharedTagsRepository>)tagsRepository userStore:(id<SharedUserStore>)userStore __attribute__((swift_name("init(pocketApi:tagsRepository:userStore:)"))) __attribute__((objc_designated_initializer));
...
__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("MainViewState")))
@interface SharedMainViewState : SharedBase
- (instancetype)initWithTags:(NSArray<SharedTag *> *)tags latestUntagged:(NSArray<SharedArticle *> *)latestUntagged __attribute__((swift_name("init(tags:latestUntagged:)"))) __attribute__((objc_designated_initializer));
- (NSArray<SharedTag *> *)component1 __attribute__((swift_name("component1()")));
- (NSArray<SharedArticle *> *)component2 __attribute__((swift_name("component2()")));
- (SharedMainViewState *)doCopyTags:(NSArray<SharedTag *> *)tags latestUntagged:(NSArray<SharedArticle *> *)latestUntagged __attribute__((swift_name("doCopy(tags:latestUntagged:)")));
- (BOOL)isEqual:(id _Nullable)other __attribute__((swift_name("isEqual(_:)")));
- (NSUInteger)hash __attribute__((swift_name("hash()")));
- (NSString *)description __attribute__((swift_name("description()")));
@property (readonly) NSArray<SharedArticle *> *latestUntagged __attribute__((swift_name("latestUntagged")));
@property (readonly) NSArray<SharedTag *> *tags __attribute__((swift_name("tags")));
@end;
...
__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("PocketApi")))
@interface SharedPocketApi : SharedBase
- (instancetype)init __attribute__((swift_name("init()"))) __attribute__((objc_designated_initializer));
+ (instancetype)new __attribute__((availability(swift, unavailable, message="use object initializers instead")));
...
/**
 ...
 Other uncaught Kotlin exceptions are fatal.
*/
- (void)addTagId:(NSString *)tagId articleId:(NSString *)articleId accessToken:(NSString *)accessToken completionHandler:(void (^)(SharedBoolean * _Nullable, NSError * _Nullable))completionHandler __attribute__((swift_name("add(tagId:articleId:accessToken:completionHandler:)")));

/**
 @note This method converts instances of CancellationException to errors.
 Other uncaught Kotlin exceptions are fatal.
*/
- (void)allArticlesAccessToken:(NSString *)accessToken completionHandler:(void (^)(NSArray<SharedArticle *> * _Nullable, NSError * _Nullable))completionHandler __attribute__((swift_name("allArticles(accessToken:completionHandler:)")));

/**
 @note This method converts instances of CancellationException to errors.
 Other uncaught Kotlin exceptions are fatal.
*/
- (void)archiveArticleId:(NSString *)articleId accessToken:(NSString *)accessToken completionHandler:(void (^)(SharedBoolean * _Nullable, NSError * _Nullable))completionHandler __attribute__((swift_name("archive(articleId:accessToken:completionHandler:)")));

/**
 @note This method converts instances of CancellationException to errors.
 Other uncaught Kotlin exceptions are fatal.
*/
- (void)continueLoginCode:(NSString *)code completionHandler:(void (^)(NSString * _Nullable, NSError * _Nullable))completionHandler __attribute__((swift_name("continueLogin(code:completionHandler:)")));

/**
 @note This method converts instances of CancellationException to errors.
 Other uncaught Kotlin exceptions are fatal.
*/
- (void)getArticlesWithTagTag:(NSString *)tag accessToken:(NSString *)accessToken maxCount:(SharedInt * _Nullable)maxCount offset:(int32_t)offset full:(BOOL)full completionHandler:(void (^)(NSArray<SharedArticle *> * _Nullable, NSError * _Nullable))completionHandler __attribute__((swift_name("getArticlesWithTag(tag:accessToken:maxCount:offset:full:completionHandler:)")));

/**
 @note This method converts instances of CancellationException to errors.
 Other uncaught Kotlin exceptions are fatal.
*/
- (void)requestAccessRedirectUrl:(SharedKtor_httpUrl *)redirectUrl completionHandler:(void (^)(NSString * _Nullable, NSError * _Nullable))completionHandler __attribute__((swift_name("requestAccess(redirectUrl:completionHandler:)")));
@end;

__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("PocketApi.AuthorizeBody")))
@interface SharedPocketApiAuthorizeBody : SharedBase
- (instancetype)initWithConsumerKey:(NSString *)consumerKey code:(NSString *)code __attribute__((swift_name("init(consumerKey:code:)"))) __attribute__((objc_designated_initializer));
- (NSString *)component1 __attribute__((swift_name("component1()")));
- (NSString *)component2 __attribute__((swift_name("component2()")));
- (SharedPocketApiAuthorizeBody *)doCopyConsumerKey:(NSString *)consumerKey code:(NSString *)code __attribute__((swift_name("doCopy(consumerKey:code:)")));
- (BOOL)isEqual:(id _Nullable)other __attribute__((swift_name("isEqual(_:)")));
- (NSUInteger)hash __attribute__((swift_name("hash()")));
- (NSString *)description __attribute__((swift_name("description()")));
@property (readonly) NSString *code __attribute__((swift_name("code")));
@property (readonly) NSString *consumerKey __attribute__((swift_name("consumerKey")));
@end;

__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("PocketApi.AuthorizeBodyCompanion")))
@interface SharedPocketApiAuthorizeBodyCompanion : SharedBase
+ (instancetype)alloc __attribute__((unavailable));
+ (instancetype)allocWithZone:(struct _NSZone *)zone __attribute__((unavailable));
+ (instancetype)companion __attribute__((swift_name("init()")));
- (id<SharedKotlinx_serialization_coreKSerializer>)serializer __attribute__((swift_name("serializer()")));
...
__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("PocketApi.AuthorizeResponse")))
@interface SharedPocketApiAuthorizeResponse : SharedBase
...
- (NSString *)component1 __attribute__((swift_name("component1()")));
- (SharedPocketApiAuthorizeResponse *)doCopyAccessToken:(NSString *)accessToken __attribute__((swift_name("doCopy(accessToken:)")));
- (BOOL)isEqual:(id _Nullable)other __attribute__((swift_name("isEqual(_:)")));
- (NSUInteger)hash __attribute__((swift_name("hash()")));
- (NSString *)description __attribute__((swift_name("description()")));
...
__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("PocketApi.AuthorizeResponseCompanion")))
@interface SharedPocketApiAuthorizeResponseCompanion : SharedBase
+ (instancetype)alloc __attribute__((unavailable));
+ (instancetype)allocWithZone:(struct _NSZone *)zone __attribute__((unavailable));
+ (instancetype)companion __attribute__((swift_name("init()")));
- (id<SharedKotlinx_serialization_coreKSerializer>)serializer __attribute__((swift_name("serializer()")));
...
__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("RequestAuthBody")))
@interface SharedRequestAuthBody : SharedBase
- (instancetype)initWithAppKey:(NSString *)appKey redirectUri:(NSString *)redirectUri __attribute__((swift_name("init(appKey:redirectUri:)"))) __attribute__((objc_designated_initializer));
- (NSString *)component1 __attribute__((swift_name("component1()")));
- (NSString *)component2 __attribute__((swift_name("component2()")));
- (SharedRequestAuthBody *)doCopyAppKey:(NSString *)appKey redirectUri:(NSString *)redirectUri __attribute__((swift_name("doCopy(appKey:redirectUri:)")));
- (BOOL)isEqual:(id _Nullable)other __attribute__((swift_name("isEqual(_:)")));
- (NSUInteger)hash __attribute__((swift_name("hash()")));
- (NSString *)description __attribute__((swift_name("description()")));
@property (readonly) NSString *appKey __attribute__((swift_name("appKey")));
@property (readonly) NSString *redirectUri __attribute__((swift_name("redirectUri")));
@end;

__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("RequestAuthBody.Companion")))
@interface SharedRequestAuthBodyCompanion : SharedBase
+ (instancetype)alloc __attribute__((unavailable));
+ (instancetype)allocWithZone:(struct _NSZone *)zone __attribute__((unavailable));
+ (instancetype)companion __attribute__((swift_name("init()")));
- (id<SharedKotlinx_serialization_coreKSerializer>)serializer __attribute__((swift_name("serializer()")));
...
@interface SharedRequestResponse : SharedBase
- (instancetype)initWithCode:(NSString *)code __attribute__((swift_name("init(code:)"))) __attribute__((objc_designated_initializer));
- (NSString *)component1 __attribute__((swift_name("component1()")));
- (SharedRequestResponse *)doCopyCode:(NSString *)code __attribute__((swift_name("doCopy(code:)")));
- (BOOL)isEqual:(id _Nullable)other __attribute__((swift_name("isEqual(_:)")));
- (NSUInteger)hash __attribute__((swift_name("hash()")));
- (NSString *)description __attribute__((swift_name("description()")));
@property (readonly) NSString *code __attribute__((swift_name("code")));
...
@interface SharedRequestResponseCompanion : SharedBase
+ (instancetype)alloc __attribute__((unavailable));
+ (instancetype)allocWithZone:(struct _NSZone *)zone __attribute__((unavailable));
+ (instancetype)companion __attribute__((swift_name("init()")));
- (id<SharedKotlinx_serialization_coreKSerializer>)serializer __attribute__((swift_name("serializer()")));
...
- (instancetype)initWithId:(NSString *)id name:(NSString *)name numberOfArticles:(int32_t)numberOfArticles __attribute__((swift_name("init(id:name:numberOfArticles:)"))) __attribute__((objc_designated_initializer));
- (NSString *)component1 __attribute__((swift_name("component1()")));
- (NSString *)component2 __attribute__((swift_name("component2()")));
- (int32_t)component3 __attribute__((swift_name("component3()")));
- (SharedTag *)doCopyId:(NSString *)id name:(NSString *)name numberOfArticles:(int32_t)numberOfArticles __attribute__((swift_name("doCopy(id:name:numberOfArticles:)")));
- (BOOL)isEqual:(id _Nullable)other __attribute__((swift_name("isEqual(_:)")));
- (NSUInteger)hash __attribute__((swift_name("hash()")));
- (NSString *)description __attribute__((swift_name("description()")));
@property (readonly) NSString *id __attribute__((swift_name("id")));
@property (readonly) NSString *name __attribute__((swift_name("name")));
@property (readonly) int32_t numberOfArticles __attribute__((swift_name("numberOfArticles")));
@end;

__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("TagResponse")))
@interface SharedTagResponse : SharedBase
...
- (NSString *)component1 __attribute__((swift_name("component1()")));
- (SharedTagResponse *)doCopyItemId:(NSString *)itemId __attribute__((swift_name("doCopy(itemId:)")));
- (BOOL)isEqual:(id _Nullable)other __attribute__((swift_name("isEqual(_:)")));
- (NSUInteger)hash __attribute__((swift_name("hash()")));
- (NSString *)description __attribute__((swift_name("description()")));
...
__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("TagResponse.Companion")))
@interface SharedTagResponseCompanion : SharedBase
+ (instancetype)alloc __attribute__((unavailable));
+ (instancetype)allocWithZone:(struct _NSZone *)zone __attribute__((unavailable));
+ (instancetype)companion __attribute__((swift_name("init()")));
- (id<SharedKotlinx_serialization_coreKSerializer>)serializer __attribute__((swift_name("serializer()")));
...
__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("TagViewState")))
@interface SharedTagViewState : SharedBase
- (instancetype)initWithTag:(SharedTag *)tag articles:(NSArray<SharedArticle *> *)articles __attribute__((swift_name("init(tag:articles:)"))) __attribute__((objc_designated_initializer));
- (SharedTag *)component1 __attribute__((swift_name("component1()")));
- (NSArray<SharedArticle *> *)component2 __attribute__((swift_name("component2()")));
- (SharedTagViewState *)doCopyTag:(SharedTag *)tag articles:(NSArray<SharedArticle *> *)articles __attribute__((swift_name("doCopy(tag:articles:)")));
- (BOOL)isEqual:(id _Nullable)other __attribute__((swift_name("isEqual(_:)")));
- (NSUInteger)hash __attribute__((swift_name("hash()")));
- (NSString *)description __attribute__((swift_name("description()")));
@property (readonly) NSArray<SharedArticle *> *articles __attribute__((swift_name("articles")));
@property (readonly) SharedTag *tag __attribute__((swift_name("tag")));
@end;

__attribute__((swift_name("TagsRepository")))
@protocol SharedTagsRepository
@required
...
/**
 ...
 Other uncaught Kotlin exceptions are fatal.
*/
- (void)allTagsIgnoreCache:(BOOL)ignoreCache completionHandler:(void (^)(NSArray<NSString *> * _Nullable, NSError * _Nullable))completionHandler __attribute__((swift_name("allTags(ignoreCache:completionHandler:)")));
@end;

__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("TagsFromArticlesRepository")))
@interface SharedTagsFromArticlesRepository : SharedBase <SharedTagsRepository>
- (instancetype)initWithPocketApi:(SharedPocketApi *)pocketApi userStore:(id<SharedUserStore>)userStore __attribute__((swift_name("init(pocketApi:userStore:)"))) __attribute__((objc_designated_initializer));
...
__attribute__((swift_name("URLLauncher")))
@protocol SharedURLLauncher
@required
- (void)launchUrl:(NSString *)url __attribute__((swift_name("launch(url:)")));
@end;

__attribute__((swift_name("UserStore")))
@protocol SharedUserStore
@required
- (NSString * _Nullable)getKey:(NSString *)key __attribute__((swift_name("get(key:)")));
- (SharedKotlinArray<NSString *> * _Nullable)getStringArrayKey:(NSString *)key __attribute__((swift_name("getStringArray(key:)")));
...
@property NSArray<NSString *> *storedTags __attribute__((swift_name("storedTags")));
@end;

__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("UserDefaultsStore")))
@interface SharedUserDefaultsStore : SharedBase <SharedUserStore>
- (instancetype)init __attribute__((swift_name("init()"))) __attribute__((objc_designated_initializer));
+ (instancetype)new __attribute__((availability(swift, unavailable, message="use object initializers instead")));
- (NSString * _Nullable)getKey:(NSString *)key __attribute__((swift_name("get(key:)")));
...
@property (class, readonly) NSString *consumerKey __attribute__((swift_name("consumerKey")));
@end;

__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("LoginViewModelKt")))
@interface SharedLoginViewModelKt : SharedBase
@property (class, readonly) NSString *redirectUrl __attribute__((swift_name("redirectUrl")));
@end;
